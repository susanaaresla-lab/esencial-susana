...
export default function ListaEsperaPage() {
  ...
  useEffect(() => {
    // Cargar el script de EmailOctopus
    ...
    <div style={{ paddingTop: 80 }}>
      ...
      <section style={{ background: 'linear-gradient(to bottom, var(--peach) 0%, var(--white) 100%)', padding: '4rem 1.5rem 5rem' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div className="t-label" style={{ color: 'var(--coral)', marginBottom: '1rem' }}>
            Próxima edición
          </div>
          ...
          <p style={{ fontSize: '1.2rem', color: 'rgba(26,26,26,0.75)', lineHeight: 1.75, marginBottom: '2rem', maxWidth: 540, margin: '0 auto 2rem' }}>
          ...
          <div style={{
            ...
            <h2 className="t-serif" style={{ fontSize: '1.75rem', color: 'var(--black)', marginBottom: '0.5rem', fontWeight: 400 }}>
              Reserva tu plaza
            </h2>
      ...
      <section className="section" style={{ background: 'var(--white)' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 1.5rem' }}>
          <div className="text-center" style={{ marginBottom: '3rem' }}>
            ...
            <h2 className="t-serif" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--black)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
            {[
              ...
              { Icon: Users, title: 'Comunidad', desc: 'Más de 3.000 mamás ya se han recuperado con este programa. Tú puedes ser la siguiente.' }
              ...
              <div key={i} style={{ background: 'var(--beige)', borderRadius: 4, padding: '1.5rem' }}>
                ...
                <h4 style={{ fontWeight: 600, fontSize: '1rem', marginBottom: '0.4rem', color: 'var(--black)' }}>{title}</h4>
      ...
      <section className="section" style={{ background: 'var(--beige)' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', padding: '0 1.5rem' }}>
          <h2 className="t-serif text-center" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', marginBottom: '2.5rem' }}>
      ...
      <section className="section" style={{ background: 'var(--white)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          <div className="text-center" style={{ marginBottom: '2.5rem' }}>
            ...
            <h2 className="t-serif" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', color: 'var(--black)' }}>
              Más de 3.000 mamás ya lo han hecho
            </h2>
          </div>
