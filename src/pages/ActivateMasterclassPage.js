...
export default function ActivateMasterclassPage() {
  ...
  return (
    <div style={{ paddingTop: 80 }}>
      ...
      <Helmet>
        <title>Acceso prioritario masterclass | Método Esencial Madre: Actívate</title>
        <meta name="description" content="Acceso prioritario exclusivo para asistentes a la masterclass. Método Esencial Madre: Actívate." />
        {/* No indexar por Google */}
        <meta name="robots" content="noindex, nofollow" />
        <meta property="og:url" content="https://esencialsusanaares.com/activate-masterclass" />
      </Helmet>

      {/* ── BLOQUE ACCESO PRIORITARIO ── */}
      <div style={{ background: 'var(--black)', borderTop: '4px solid var(--coral)', padding: '1.5rem 1.5rem' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'var(--coral)', color: 'white', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0.35rem 1rem', borderRadius: 999, marginBottom: '1rem' }}>
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.9)', lineHeight: 1.7, margin: 0 }}>
            Como has asistido a la masterclass, tienes acceso anticipado al <strong style={{ color: 'var(--coral)' }}>Método Esencial Madre: Actívate</strong> con precio especial antes de que abra al público general el 11 de junio.{' '}
            <strong style={{ color: 'white' }}>Este acceso caduca el {FECHA_CIERRE}.</strong>
          </p>
        </div>
      </div>
      ...
      <section style={{ background: 'linear-gradient(to bottom, var(--peach) 0%, var(--white) 100%)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container-mid" style={{ position: 'relative', zIndex: 2, paddingTop: '2rem', paddingBottom: '4rem' }}>
          <div className="hero-text-wrap">
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--coral)', fontWeight: 600, marginBottom: '1.5rem' }}>⚡ Solo para las primeras 80 madres · Acceso caduca el {FECHA_CIERRE}</p>
        ...
        <div className="container-mid">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3.5rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <button className="btn-coral" onClick={goComprar}>Quiero empezar mi recuperación — €97</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="comprar" className="section" style={{ background: 'var(--white)' }}>
        <div className="container-narrow">
          <div className="text-center" style={{ marginBottom: '2rem' }}>
            <div style={label('var(--coral)')}>Acceso prioritario masterclass · Caduca el {FECHA_CIERRE}</div>
          ...
          <div className="card" style={{ padding: '2.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', background: 'rgba(26,26,26,0.04)', border: '1px solid rgba(26,26,26,0.12)', borderRadius: 4, padding: '1rem', marginBottom: '2rem' }}>
              ...
              <div>
                <p style={{ fontWeight: 600, fontSize: '0.95rem', color: 'var(--coral)', marginBottom: '0.25rem' }}>Acceso prioritario exclusivo para asistentes a la masterclass</p>
                <p style={{ fontSize: '0.9rem', color: 'rgba(26,26,26,0.65)', lineHeight: 1.65 }}>Este precio especial caduca el {FECHA_CIERRE}. Después abrirá al público general el 11 de junio.</p>
              </div>
            </div>
            <div className="text-center" style={{ borderTop: '1px solid var(--pearl)', paddingTop: '2rem' }}>
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--coral)', fontWeight: 600, marginTop: '0.4rem' }}>⚡ Precio especial solo para las primeras 80 madres</p>
              </div>
      ...
      <div className="cta-band">
        <div className="container-narrow text-center">
          ...
          <p style={{ fontSize: '1.15rem', marginBottom: '1rem', opacity: 0.9 }}>Tu acceso prioritario caduca el {FECHA_CIERRE}.</p>
          <div style={{ fontFamily: 'var(--sans)', fontWeight: 700, fontSize: '2rem', color: 'white', marginBottom: '0.25rem' }}>€97</div>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.5rem' }}>⚡ Solo para las primeras 80 madres</p>
