...
export default function MasterclassPage() {
    ...
    script.async = true;
    document.getElementById('eo-form-container-ev')?.appendChild(script);
    return () => {
      const container = document.getElementById('eo-form-container-ev');
