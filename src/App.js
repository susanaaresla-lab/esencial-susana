...
function AppContent() {
  ...
  const noHeaderFooter = ['/masterclass', '/masterclass-recuperacion', '/gracias-masterclass', '/gracias-lista-espera', '/gracias-avanza', '/acceso-prioritario'].includes(location.pathname);
